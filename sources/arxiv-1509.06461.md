...
2. Use the online network with parameters $\boldsymbol{\theta}_{t}$ to select the greedy action in the next state: $a^* = \underset{a}{\operatorname{argmax}} Q(S_{t+1}, a; \boldsymbol{\theta}_{t})$.
...
$$Y_t^{\mathrm{DoubleDQN}} \equiv R_{t+1} + \gamma Q(S_{t+1}, \underset{a}{\operatorname{argmax}} Q(S_{t+1}, a; \boldsymbol{\theta}_{t}), \boldsymbol{\theta}_{t}^{-})$$
