...
$$
\frac{|\text{med} x - \bar{x}|}{s} \leq \begin{cases} \left( \frac{k}{k+1} \right)^{1/2} & \text{if } n = 2k + 1, \\ \left( \frac{k-1}{k+1} \right)^{1/2} & \text{if } n = 2k. \end{cases}
$$
